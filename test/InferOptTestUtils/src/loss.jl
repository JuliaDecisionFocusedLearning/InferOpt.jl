...
get_loss(::PipelineLossImitation, loss, res, x, θ, y) = loss(res, y)
get_loss(::PipelineLossImitationθ, loss, res, x, θ, y) = loss(res, θ)
get_loss(::PipelineLossImitationθy, loss, res, x, θ, y) = loss(res, θ, y)
function get_loss(::PipelineLossImitationLoss, loss, res, x, θ, y)
    return loss(res, (; y_true=y, θ_true=θ))
end
